...
logging.basicConfig(
    ...
    level=logging.WARNING,  # Increase verbosity
...
def display_options(username, password, action_choice, devices, selected_device_type, pause_option, timeout, input_file_name, output_formats, use_parallel):
    ...
    print("\nPress '1' to run the script or '2' to edit options.")

def edit_options():
    while True:
        print("Select the category to edit:")
        print("1. Device Type")
        print("2. Username and Password")
        print("3. Action Choice")
        print("4. Device Information")
        print("5. Pause Option and Timeout")
        print("6. Output Formats")
        print("7. Parallel Execution")
        print("8. Go Back to Summary")
        choice = input("Enter the number of the category to edit: ").strip()
...
def input_with_options(prompt, options):
    while True:
        ...
        if response in options:
            return response
        print(f"Invalid input. Please choose one of the following: {', '.join(options)}")
